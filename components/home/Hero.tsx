...
function Hero() {
  return (
    <>
      ...
      >
        <p className="text-xl mb-5">Hey, I'm Aswath C M.</p>
        <h1 className="heroTitle inline-block max-w-2xl lg:max-w-4xl  w-auto relative text-5xl md:text-6xl lg:text-7xl tracking-tighter mb-10 font-bold heroShinyBg">
          Developing <span className="heroShiny1 text-fun-pink">thoughts </span>into{" "}
          <span className="heroShiny2 text-fun-pink">code</span> creating full-stack flow.
          <img
